...
function Heading({ tag }: HeadingProps) {
  return (
    ...
    >
      {tag ? (
        <>
          <h1 className="text-3xl sm:text-4xl inline-block w-auto mx-auto mb-8 relative">
            Proyectos construidos con <b>{tag}</b>
            <img
      ...
      Exploro soluciones funcionales y bien diseñadas a través de proyectos que van desde 
      sistemas de reservas 24/7 hasta plataformas creativas y tiendas digitales. 
      Cada desarrollo refleja un enfoque en calidad, claridad y valor real para el usuario.
        </p>
      )}
    </div>
  );
