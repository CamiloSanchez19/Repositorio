    ...
    <footer className="flex flex-col w-screen px-5 py-10 border-t border-fun-pink-darker z-5 bg-bg">
          ...
          <div className="space-y-2 mt-4 w-full flex items-center sm:items-start flex-col">
            {footer.support.buymeacoffee !== "" && (
              <div>
                ...
                >
                  <img
                    src="/static/misc/correo-electronico.png"
            ...
            {footer.support.paypal !== "" && (
              <div>
                <a
                  href="https://wa.me/573165830227"
                  target="_blank"
                >
                  <img
                    src="/static/misc/celular.png"
                    className="h-12 mr-2 hover:opacity-80 opacity-100 transition-opacity"
                  />
                </a>
              </div>
      ...
      <div className="mt-8 text-center sm:text-right sm:-mt-12">
        <a
          ...
          href="https://github.com/CamiloSanchez19/Repositorio"
          target="_blank"
          rel="nooreferrer"
        >
          <Image
            ...
            alt="Github Icon"
          />
          <span className="ml-2">Ver código fuente </span>
        </a>
      </div>
    </footer>
  );
